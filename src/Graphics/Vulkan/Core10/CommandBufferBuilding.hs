...
--     @viewportCount@ valid @VkViewport@ structures
--
-- -   @commandBuffer@ /must/ be in the [recording
--     state](https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#commandbuffers-lifecycle)
--
...
--     'Graphics.Vulkan.Core10.DescriptorSet.VkDescriptorSet' objects
...
--     buffer specified in the bound descriptor set
--
-- -   If a @VkImageView@ is sampled with with @VK_FILTER_LINEAR@ as a
--     result of this command, then the image view’s [format
--     features](https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#resources-image-view-format-features)
--     /must/ contain @VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_LINEAR_BIT@.
--
-- -   If a @VkImageView@ is sampled with with @VK_FILTER_CUBIC_IMG@ as a
--     result of this command, then the image view’s [format
--     features](https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#resources-image-view-format-features)
--     /must/ contain
--     @VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_IMG@.
...
--     of @srcImage@ /must/ contain @VK_FORMAT_FEATURE_TRANSFER_SRC_BIT@.
--
...
-- -   The [format
--     features](https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#resources-image-format-features)
--     of @dstImage@ /must/ contain @VK_FORMAT_FEATURE_TRANSFER_DST_BIT@.
--
...
-- -   The [format
--     features](https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#resources-image-format-features)
--     of @srcImage@ /must/ contain @VK_FORMAT_FEATURE_BLIT_SRC_BIT@.
--
...
-- -   The [format
--     features](https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#resources-image-format-features)
--     of @dstImage@ /must/ contain @VK_FORMAT_FEATURE_BLIT_DST_BIT@.
--
...
--     Addressing](https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#copies-buffers-images-addressing),
...
-- -   The [format
--     features](https://www.khronos.org/registry/vulkan/specs/1.0-extensions/html/vkspec.html#resources-image-format-features)
--     of @image@ /must/ contain @VK_FORMAT_FEATURE_TRANSFER_DST_BIT@.
--
...
--     @VkRenderPassCreateInfo@::@pDependencies@ that expresses a
--     dependency from the current subpass to itself, and for which
--     @srcStageMask@ contains a subset of the bit values in
--     @VkSubpassDependency@::@srcStageMask@, @dstStageMask@ contains a
--     subset of the bit values in @VkSubpassDependency@::@dstStageMask@,
--     and @dependencyFlags@ is equal to
--     @VkSubpassDependency@::@dependencyFlags@.
--
-- -   If @vkCmdPipelineBarrier@ is called within a render pass instance,
--     for each element of @pMemoryBarriers@ and @pImageMemoryBarriers@,
--     the render pass /must/ have been defined with a
--     @VkSubpassDependency@ self-dependency for the current subpass with
--     valid @srcStageMask@, @dstStageMask@, and @dependencyFlags@ values
--     such that @Vk*Barrier@::@srcAccessMask@ contains a subset of the bit
--     values in @VkSubpassDependency@::@srcAccessMask@ and
--     @Vk*Barrier@::@dstAccessMask@ contains a subset of the bit values in
...
--
-- -   @dstBuffer@ is a 'Graphics.Vulkan.Core10.MemoryManagement.VkBuffer'
